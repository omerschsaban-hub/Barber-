...
const projects: { name: string; meta: string; status: string; tone: 'success' | 'warning' | 'danger' | 'neutral' }[] = [
...
const styles = StyleSheet.create({ content: { paddingBottom: 30 }, row: { flexDirection: 'row', alignItems: 'center', gap: 10 }, copy: { flex: 1 }, name: { color: theme.text, fontSize: 17, fontWeight: '700' }, meta: { color: theme.muted, fontSize: 12, marginTop: 5 }, divider: { height: 1, backgroundColor: theme.border, marginVertical: 14 }, small: { color: theme.muted, fontSize: 12, flex: 1 }, open: { color: theme.text, fontSize: 12, fontWeight: '700' } })
