...
_register('Existing Fabrient engineering endpoint: /v1/predict','/v1/predict')
...
_register('Existing Fabrient capability adapter: /v1/simulate','/v1/simulate')
