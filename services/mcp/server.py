...
mcp = FastMCP("Fabrient Engineering", instructions="Fabrient MCP: deterministic engineering algorithms + measured-evidence ML + bounded engineering/LLM orchestration. Never invent measurements or confidence. Every tool returns or preserves evidence, status, and provenance where the engine supports it.", transport_security=TRANSPORT_SECURITY, stateless_http=True)
