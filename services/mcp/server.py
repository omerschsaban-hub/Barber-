...
CAPABILITY_REGISTRY: tuple[tuple[str, str, str], ...] = (
    ...
    ("cad_step_extract", "Extract supported STEP geometry; this is inspection/extraction only, not CAD generation.", "/v1/geometry/step"),
    ...
    ("sim2real_calibrate_and_run", "Run calibrated sim-to-real only after real observations pass the held-out validation gate.", "/v1/sim2real/calibrate-and-run"),
    ("cv_measure_real_json", "Measure real millimetres from base64 image data using an explicit physical reference.", "/v1/cv/measure-real-json"),
    ...
    ("cad_manufacturing_risk", "Review manufacturing risk of supplied CAD/geometry; never generate CAD.", "/v1/toolbox/analyze_dfm"),
    ("cad_wall_clearance_review", "Review supplied geometry wall and clearance risk.", "/v1/toolbox/check_wall_thickness"),
    ("cad_hole_review", "Review supplied geometry holes.", "/v1/toolbox/check_holes"),
    ("cad_overhang_review", "Review supplied geometry overhangs.", "/v1/toolbox/check_overhangs"),
    ("cad_bridge_review", "Review supplied geometry bridges.", "/v1/toolbox/check_bridges"),
    ("cad_tolerance_review", "Review supplied geometry tolerances.", "/v1/toolbox/check_tolerances"),
    ("risk_map", "Compute a deterministic evidence-backed engineering risk map; never convert risk into physical acceptance.", "/v1/risk-map"),
