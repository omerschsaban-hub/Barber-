...
_supabase_key = next((os.getenv(name, "").strip() for name in ("SUPABASE_SERVICE_ROLE_KEY", "SUPABASE_SERVICE_KEY", "SUPABASE_SERVICE_ROLE", "SUPABASE_SECRET_KEY", "SUPABASE_KEY") if os.getenv(name, "").strip()), "")
